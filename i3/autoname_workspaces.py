...
WINDOW_ICONS = {
    'steam': fa.icons['steam-square'],
    'netease-cloud-music': fa.icons['mixcloud'],
    'code': fa.icons['file-code-o'],
    'emacs': fa.icons['pencil-square-o'],
    'typora': fa.icons['pencil-square-o'],
    'nteract': fa.icons['pencil-square-o'],
    'thunar': fa.icons['file-pdf-o'],
    ...
    'mathematica': fa.icons['calculator'],
    'mendeleydesktop.x86_64': fa.icons['database'],
    'spotify': fa.icons['spotify'],
    'libreoffice-impress': fa.icons['file-powerpoint-o'],
    'wpp': fa.icons['file-powerpoint-o'],
    'libreoffice-draw': fa.icons['paint-brush'],
    'libreoffice-writer': fa.icons['file-word-o'],
    'wps': fa.icons['file-word-o'],
    'et': fa.icons['file-excel-o'],
}
